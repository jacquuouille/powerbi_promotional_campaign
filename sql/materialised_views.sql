...
AS
   ...
   -- 'value' -> to unnest in order to have 'offer_id', 'reward' and 'amount' as extra columns. Extracting the data this way removed duplicates (for offer completions, 371 records were duplicated (≈2.5%)).
	 	, case 
