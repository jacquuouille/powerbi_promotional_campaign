# Power BI Project: Offer Campaign Analysis Dashboard

## Overview 
Proviving a comprehensive view of coffee shop members’ behavior over a 30-day period, including their transactions and responses to promotional offers.
...
![Offer Campaign Analysis Dashboard](screenshots/dashboard_overview.png)
...
![Star Schema Data Model](screenshots/star_data_model.png)
...
## 📈 Key Learnings
 ...
 2. **Customer loyalty is a strong driver of engagement:** long-term customers show the highest interest in promotional offers (65%) compared to new accounts (31%). The same pattern holds when analyzing engagement by age. Besides, male customers are the least responsive segments (43% vs. ~55% for Females and other genders).
 ...
 6. **Sending offers more frequently significantly boosts customer engagement** (+$15K of average daily revenue compared to weekly campaigns).
